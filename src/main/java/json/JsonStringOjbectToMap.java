...
public class JsonStringOjbectToMap {
    public static void main(String[] args) {
        ...
        String jsonStr = "[\n" +
                "{ \"value\": \"http://publish1.ydsworld.com:4503\", \"text\": \"Production Publish (http://publish1.ydsworld.com:4503)\"},\n" +
                "{ \"value\": \"http://publish.prb.ydsworld.com:4503\", \"text\": \"PRB Publish (http://publish.prb.ydsworld.com:4503)\"},\n" +
                "{ \"value\": \"http://publish1.qa.ydsworld.com:4503\", \"text\": \"QA Publish (http://publish1.qa.ydsworld.com:4503)\"}\n" +
                "]";
